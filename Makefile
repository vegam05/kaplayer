#############################################################################
# Makefile for building: kaplayer
# Generated by qmake (3.1) (Qt 5.15.16)
# Project:  kaplayer.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile kaplayer.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = kaplayer1.0.0
DISTDIR = /storage/Dev/kaplayer/.tmp/kaplayer1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -pipe -O2 -flto=12 -fno-fat-lto-objects -fuse-linker-plugin -Wl,-rpath-link,/usr/lib -fPIC
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		kaplayer.pro mainwindow.h main.cpp \
		mainwindow.cpp
QMAKE_TARGET  = kaplayer
DESTDIR       = 
TARGET        = kaplayer
...
kaplayer: ui_mainwindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: kaplayer.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
